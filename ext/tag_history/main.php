...
class TagHistory extends Extension
{
    ...
    public function onPageRequest(PageRequestEvent $event): void
    {
        ...
        } elseif ($event->page_matches("tag_history/all/{page}", permission: Permissions::VIEW_TAGS)) {
            $page_id = $event->get_iarg('page');
            $this->theme->display_global_page($page, $this->get_global_tag_history($page_id), $page_id);
        } elseif ($event->page_matches("tag_history/{image_id}", permission: Permissions::VIEW_TAGS)) {
